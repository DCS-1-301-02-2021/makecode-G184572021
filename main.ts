...
let spacePlane = sprites.create(img`
    ...
    2 2 5 5 1 1 1 1 1 2 2 2 1 1 1 1
    2 2 5 5 1 1 1 1 1 2 2 1 1 1 1 1
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Enemy, function on_crach(sprite: Sprite, othersprite: Sprite) {
    othersprite.destroy()
    info.changeLifeBy(-1)
})
